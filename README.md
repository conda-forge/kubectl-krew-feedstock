...
Development: https://github.com/kubernetes-sigs/krew
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/kubectl-krew-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/kubectl-krew-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add kubectl-krew
# for installing globally
pixi global install kubectl-krew
```
...
It is possible to list all of the versions of `kubectl-krew` available on your platform:
...
```
pixi search kubectl-krew --channel conda-forge
```
